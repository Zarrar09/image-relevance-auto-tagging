...
async def main():
    ...
    print("post | expected image | guard top pick | distance | decision | correct?")
    print("-" * 78)
    ...
    for entry in eval_entries:
        ...
        print(f"{post_id:>4} | {correct_image_id:>14} | {top_image_id:>14} | {distance:>8.3f} | {result:>8} | {correct_label}")
